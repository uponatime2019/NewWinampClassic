...
public sealed partial class QueuePage : Page
{
    ...
    public QueuePage()
    {
        ...
        QueueListView.ItemClick += async (_, args) =>
        {
    ...
    {
        QueueListView.ItemTemplate = (DataTemplate)Microsoft.UI.Xaml.Markup.XamlReader.Load("""
    ...
    {
        if (QueueListView is not null)
            QueueListView.ItemsSource = ViewModel.QueueSongs;
        if (QueueInfo is not null)
            QueueInfo.Text = $"{ViewModel.QueueSongs.Count} songs in queue";
    }
