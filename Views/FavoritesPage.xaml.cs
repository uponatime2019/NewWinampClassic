...
public sealed partial class FavoritesPage : Page
{
    ...
    public FavoritesPage()
    {
        ...
        FavoritesListView.ItemClick += async (_, args) =>
        {
    ...
    {
        FavoritesListView.ItemTemplate = (DataTemplate)Microsoft.UI.Xaml.Markup.XamlReader.Load("""
    ...
    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        if (FavoritesListView is not null)
            FavoritesListView.ItemsSource = ViewModel.FavoriteSongs;
    }
